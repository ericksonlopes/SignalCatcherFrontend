...
export const INITIAL_CAPTURES: CapturedVideo[] = [
  {
    id: 'vid-101',
    sourceId: 'src-2',
    sourceName: 'Fireship Code Briefs',
    sourceAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80',
    title: 'Python 3.14 Features You Need to Know in 100 Seconds',
    videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    thumbnail: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=600&auto=format&fit=crop&q=80',
    publishedAt: '2026-08-07T05:35:12Z',
    duration: '02:18',
    views: 184200,
    likes: 19400,
    commentsCount: 1250,
    status: 'analyzed',
    postgresRecordId: 'pg_uuid_9921_aa84',
    tags: ['Python', 'FastAPI', 'Backend', 'Performance'],
    summary: 'Explores JIT compiler optimizations, enhanced async GIL-free threading, and streamlined FastAPI type annotations in the latest release.',
    sentimentScore: 0.88
  },
  {
    id: 'vid-102',
    sourceId: 'src-1',
    sourceName: 'TechLead Chronicles',
    sourceAvatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80',
    title: 'Why I Switched My Entire Architecture to PostgreSQL & Async Python',
    videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    ...
    commentsCount: 680,
    status: 'ingested',
    postgresRecordId: 'pg_uuid_9922_bb95',
    tags: ['Architecture', 'PostgreSQL', 'FastAPI', 'Microservices'],
    summary: 'A deep dive into abandoning serverless edge DBs in favor of dedicated PostgreSQL connection pooling with SQLAlchemy 2.0 async.',
    sentimentScore: 0.65
  },
  {
    id: 'vid-103',
    sourceId: 'src-4',
    sourceName: 'Lex AI & Robotics Podcast',
    sourceAvatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80',
    title: 'Sam Altman: Humanoid Robotics, AI Systems, and Future Energy Grids',
    videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    thumbnail: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=600&auto=format&fit=crop&q=80',
    publishedAt: '2026-08-07T00:45:00Z',
    duration: '02:48:10',
    views: 890000,
    likes: 74000,
    commentsCount: 9400,
    status: 'processing',
    postgresRecordId: 'pg_uuid_9923_cc01',
    tags: ['AI', 'Robotics', 'Podcast', 'Energy'],
    summary: 'In-depth dialogue covering embodied AI models, synthetic dataset generation, and energy infrastructure requirements for compute clusters.',
    sentimentScore: 0.92
  },
  {
    id: 'vid-104',
    sourceId: 'src-3',
    sourceName: 'Python FastAPI Mastery',
    sourceAvatar: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=150&auto=format&fit=crop&q=80',
    title: 'FastAPI v0.115 Security Updates & OAuth2 Bearer Token Best Practices',
    videoUrl: 'https://fastapi.tiangolo.com/',
    thumbnail: 'https://images.unsplash.com/photo-1618401471353-b98afee0b2eb?w=600&auto=format&fit=crop&q=80',
    publishedAt: '2026-08-06T21:55:00Z',
    duration: '08:20',
    views: 31000,
    likes: 2400,
    commentsCount: 190,
    status: 'analyzed',
    postgresRecordId: 'pg_uuid_9924_dd32',
    tags: ['FastAPI', 'Security', 'OAuth2', 'JWT'],
    summary: 'Official release breakdown detailing automatic security dependency injection and refresh token rotation helpers.',
    sentimentScore: 0.74
  }
];
